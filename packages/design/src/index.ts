...
/** Tailwind's breakpoints, as pixel values and as the matching `min-width`
 *  queries -- one source for a stylesheet's `@media` rule, a `md:` utility and
 *  a `matchMedia` caller to share -- and the hook built on them. */
