...
/** The grouped place list `Shell`'s `side` slot takes -- `SideList.Group` and
 *  `SideList.Item` are properties on the default export, not separate
 *  modules, so this is the only import an app needs. */
